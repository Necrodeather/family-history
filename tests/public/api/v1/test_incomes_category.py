...
from app.infrastructure.database.models.budget import IncomesCategory
...
def endpoint_url() -> str:
    return '/api/v1/budget/incomes_category/'


async def test_get_income_categories(
    authenticated_http_client: TestClient,
    endpoint_url: str,
    income_categories: Sequence[IncomesCategory],
...
async def test_get_income_category_by_id(
    authenticated_http_client: TestClient,
    endpoint_url: str,
...
async def test_create_income_category(
    ...
    income_category_register = CategoryCreateForm(
    ...
    await create_entity(
        ...
        url=endpoint_url,
        entity=income_category,
        entity_register=income_category_register,
